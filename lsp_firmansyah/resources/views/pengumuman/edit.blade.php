    ...
    <div class="w-2/5 p-6 bg-white shadow-md rounded">
        ...
        <form action="/pengumuman/{{ $pengumuman->id }}" method="POST">
            ...
            <label for="gambar_pengumuman" class="block mb-4">
                ...
                <textarea name="gambar_pengumuman" id="gambar_pengumuman" valie="{{$pengumuman->judul_pengumuman}}" placeholder="Masukan Gambar...."  class="p-3 border border-gray-300 shadow-sm rounded w-full block text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
            </label>
